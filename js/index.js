...
var iceservers={
    "iceServers":[
        {
            urls:"stun:192.168.30.16:3478"
        },
        {
            urls:"turn:192.168.30.16:3478",
            username:"kurento",
            credential: "kurento"
        }
    ]
...
window.addEventListener('load', function(){
  console = new Console('console', console);
    ...
    // address.value = 'rtsp://admin:qwer1234@192.168.10.205:554/h264/ch1/sub/av_stream';
    // address.value = 'rtsp://admin:qwer1234@192.168.10.232:554/h264/ch1/sub/av_stream';
    address.value = 'rtsp://admin:landsky123@192.168.10.230:554/h264/ch1/sub/av_stream';
    // address.value = 'rtsp://admin:landsky123@192.168.10.230:554/h264/ch1/sub/av_stream';
  var pipeline;
  var webRtcPeer;
